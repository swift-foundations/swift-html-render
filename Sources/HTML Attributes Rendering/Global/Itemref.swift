...
extension HTML.View {
    ...
    public func itemref(
        ...
        self.attribute(HTML.Attribute.Itemref.attribute, id)
    }
    ...
    public func itemref(
        ...
        self.attribute(HTML.Attribute.Itemref.attribute, ids.joined(separator: " "))
    }
    ...
    @discardableResult
    public func itemref(
        _ attribute: HTML.Attribute.Itemref
    ) -> HTML._Attributes<Self> {
        self.attribute(HTML.Attribute.Itemref.attribute, attribute.description)
    }
}
